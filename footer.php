          ...
          <div class="col-md-4">
              <div class="full">
                 ...
                 <div class="information_f">
                   <p><strong>ADDRESS:</strong> Ordnance Factory Township- Ayudhapuram
<br>
Shardan (Amethi)
<br>
Uttar Pradesh 227412</p>
                   <p><strong>TELEPHONE:</strong>05368-255285-Extn 314</p>
             ...
             <div class="col-md-7">
                ...
                <div class="widget_menu">
                   ...
                   <ul>
                      ...
                      <li><a  href="locate.php">Locate_Us</a></li>
                      <li><a href="donate.php">Donate_Us</a></li>
                      <li><a href="people.php">Our_People</a></li>
 ...
 <!-- footer end -->
 <div class="cpy_">
    <p class="mx-auto">  © 2025 Ayudhpuram Mandir Samiti | All Rights Reserved
